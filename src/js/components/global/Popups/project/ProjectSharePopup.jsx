...
function ProjectSharePopup({ popupId = PopupProjectIdsConstants.ProjectSharePopup, popupData: { href } = {} }) {
  return (
    <Popup popupId={popupId} maxWidth={435} textAlign="center" headerText="Share Pre-order">
      <div className="w-100pct m-top-5 m-bottom-25">Select social network for sharing pre-order</div>
